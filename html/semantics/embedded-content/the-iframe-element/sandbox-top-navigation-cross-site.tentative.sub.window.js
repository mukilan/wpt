...
promise_test(async t => {
  ...
  const iframe = await createNestedIframe(main,
      "HTTP_ORIGIN", "", "");
...
}, "A cross-site iframe navigation consumes user activation and disallows " +
...
}, "A same-site iframe navigation does not consume user activation and " +
